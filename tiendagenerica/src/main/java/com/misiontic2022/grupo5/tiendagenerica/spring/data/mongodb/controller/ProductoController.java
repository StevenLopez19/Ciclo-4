...
import com.misiontic2022.grupo5.tiendagenerica.spring.data.mongodb.repository.ProductoRepository;
...
public class ProductoController {
	...
	public ResponseEntity<List<Producto>>findByCodigoproducto(@PathVariable("codigoproducto") Long codigoproducto) {
		try {
